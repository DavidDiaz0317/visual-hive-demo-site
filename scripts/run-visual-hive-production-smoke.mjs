...
const steps = [
  ...
  ["hive-beads", ["npm", ["run", "vh:hive-beads"], 120_000]],
  ["hive-validate", ["npm", ["run", "vh:hive-validate"], 120_000]],
  ["hive-setup-pack", ["npm", ["run", "vh:hive-setup-pack"], 120_000]],
  ["hive-integration-smoke", ["npm", ["run", "vh:hive-integration-smoke"], 180_000]],
  ["hive-bundle", ["npm", ["run", "vh:hive-bundle"], 120_000]],
  ...
  ["agent-validate", ["npm", ["run", "vh:agent:validate"], 120_000]],
